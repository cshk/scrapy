...
# Scrapy settings for xunying project
#
...
SPIDER_MODULES = ['xunying.spiders']
NEWSPIDER_MODULE = 'xunying.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'xunying (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'xunying.middlewares.XunyingSpiderMiddleware': 543,
#}

# Enable or disable downloader middlewares
# See https://doc.scrapy.org/en/latest/topics/downloader-middleware.html
DOWNLOADER_MIDDLEWARES = {
   'xunying.middlewares.RandomUserAgent': 543,
}
#调度器
...
ITEM_PIPELINES = {
   'xunying.pipelines.XunyingPipeline': 300,
    #item会保存到redis数据库中
...
<<<<<<< HEAD
MONGO_URI='140.143.226.245'
=======
MONGO_URI='127.0.0.1'
>>>>>>> 5f737b3053ae29556cc65a08e2afc2119486f028
MONGO_DB='xunying'
